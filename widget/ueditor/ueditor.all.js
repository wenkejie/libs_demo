...
(function () {
    ...
    var Editor = UE.Editor = function (options) {
        ...
        if(!utils.isEmptyObject(UE.I18N)){
            ...
            utils.loadFile(document, {
                src: me.options.langPath + me.options.lang + "/" + me.options.lang + ".js?v=" + UE.version,
                tag: "script",
                type: "text/javascript",
                defer: "defer"
            }, function () {
...
//                });
        ...
        setContent: function (html, isAppendTo, notFireSelectionchange) {
            ...
            //TODO 当插入的HTML中包含图片时，图片的链接在向服务端请求时，通过innerHTML赋值会造成图片的请求头中不带Referer，不能通过防盗链的验证
            //me.body.innerHTML = (isAppendTo ? me.body.innerHTML : '') + html;
            //兼容IE6  rjb 
            var objE;
            if(/MSIE 6./i.test(navigator.userAgent) || /MSIE 7./i.test(navigator.userAgent)){
            	objE = me.document.createElement("div");
            }else{
            	objE = document.createElement("div");
            }
    	　　 
    	　　 objE.innerHTML = (isAppendTo ? me.body.innerHTML : '') + html;
    	 	me.body.innerHTML="";
//    	 	while(me.body.lastChild){
//    	 		me.body.removeChild(me.body.lastChild);
//    	 	}
//    	 	var parser = new DOMParser();
//    	 	var objE = parser.parseFromString("<div>"+(isAppendTo ? me.body.innerHTML : '') + html+"</div>", "text/xml");
...
//                return el;
//            }
//            var objE = str2DOMElement("<div>"+(isAppendTo ? me.body.innerHTML : '') + html+"</div>");
    	 	while(objE.firstChild){
    	 		me.body.appendChild(objE.firstChild);
    	 	}
...
UE.commands['inserthtml'] = {
	...
	　　 objE.innerHTML = utils.trim( html );
	 	while(objE.firstChild){
	 		div.appendChild(objE.firstChild);
	 	}
...
(function (){
    ...
    UE.plugins['source'] = function (){
        ...
        if(opt.sourceEditor == "codemirror"){
            ...
            me.addListener("ready",function(){
                utils.loadFile(document,{
                    src : opt.codeMirrorJsUrl || opt.UEDITOR_HOME_URL + "third-party/codemirror/codemirror.js?v=" + UE.version,
                    tag : "script",
                    type : "text/javascript",
                    defer : "defer"
                },function(){
                ...
                utils.loadFile(document,{
                    ...
                    rel : "stylesheet",
                    type : "text/css",
                    href : opt.codeMirrorCssUrl || opt.UEDITOR_HOME_URL + "third-party/codemirror/codemirror.css?v=" + UE.version
                });
        ...
        getContentHtml: function (){
            ...
            if (typeof this.content == 'string') {
            	...
            	if(this.iframeUrl.indexOf("?")>-1){
            		iframeSrc =this.iframeUrl+ "&v=" + UE.version;
            	}else{
            		iframeSrc = this.iframeUrl+"?v=" + UE.version;
            	}
                contentHtml = '<span id="'+ this.id +'_contmask" class="dialogcontmask"></span><iframe id="'+ this.id +
                    '_iframe" class="%%-iframe" height="100%" width="100%" frameborder="0" src="'+ iframeSrc +'"></iframe>';
            }
            return contentHtml;
        },
        getHtmlTpl: function (){
...
(function () {
    ...
    UE.ui.Editor = function (options) {
        ...
        utils.loadFile(document, {
            href:editor.options.themePath + editor.options.theme + "/css/ueditor.css?v=" + UE.version,
            tag:"link",
            type:"text/css",
            rel:"stylesheet"
        });
